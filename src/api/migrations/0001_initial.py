    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[
                 ('fps', 'FPS'), ('rpg', 'RPG'), ('racing', 'Racing'), ('sports', 'Sports')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='KSUser',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ksuser', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='api.ksuser')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.paymentmethod'),
        ),
        migrations.AddField(
            model_name='ksuser',
            name='user',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='api.gamecategory'),
        ),
        migrations.AddField(
            model_name='game',
            name='price',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='api.price'),
        ),
        migrations.CreateModel(
            name='Wishlist',
            fields=[
